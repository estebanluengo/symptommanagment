package org.coursera.symptomserver.oauth;
...
public class OAuth2SecurityConfiguration {
	...
	protected static class ResourceServer extends
		...
		public void configure(HttpSecurity http) throws Exception {			
			...
			http.authorizeRequests().antMatchers("/symptom/doctors/**").access("hasRole('DOCTOR')");
			http.authorizeRequests().antMatchers("/symptom/patients/**").access("hasRole('PATIENT')");			
	...
	protected static class OAuth2Config extends
		...
		public OAuth2Config() throws Exception {
			...
			ClientDetailsService csvc = new InMemoryClientDetailsServiceBuilder()
			        ...
			        // video service
					.withClient("symptom_client")
					.authorizedGrantTypes("password")
					.authorities("ROLE_PATIENT", "ROLE_DOCTOR")
					.scopes("read","write")
					.resourceIds("symptom")
//					.and()
//					.withClient("symptom_doctor")
//					.authorizedGrantTypes("password")
...
//					.accessTokenValiditySeconds(3600)
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							User.create("patient1", "patient1", "PATIENT"),
							User.create("patient2", "patient2", "PATIENT"),
							User.create("doctor1", "doctor1", "DOCTOR"),
							User.create("doctor2", "doctor2", "DOCTOR")
							));
