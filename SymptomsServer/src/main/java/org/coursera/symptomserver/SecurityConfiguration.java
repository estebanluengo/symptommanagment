 ...
 * 
 * This class is deprecated now because the app finally uses OAUTH configuration system. 
 * I put in the project only for learning decision. 
 * @deprecated
 */
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		...
		http.formLogin()
			...
			.loginProcessingUrl(SymptomSvcApi.LOGIN_PATH)
		...
		http.logout()
			...
			.logoutUrl(SymptomSvcApi.LOGOUT_PATH)
		...
		http.authorizeRequests().antMatchers("symptom/doctors/**").hasRole("DOCTOR")
								.antMatchers("symptom/patients/**").hasRole("PATIENT")
