 ...
 ** 
 */
package org.coursera.symptom.client.oauth;
...
public class SecuredRestBuilder extends RestAdapter.Builder {
	...
	private class OAuthHandler implements RequestInterceptor {
		...
		public OAuthHandler(Client client, String token){
			super();
			this.client = client;		
	...
	public RestAdapter build() {
		...
		if (token != null){ //the class has the OAuth token. 
			hdlr = new OAuthHandler(client, token);
