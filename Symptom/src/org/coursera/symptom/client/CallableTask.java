...
/**
 * This class allows to execute work in background. It is used by the activity classes that
 * want to access to the server or to the local database for not blocking user interface. 
 * 
 * @param <T>
 */
